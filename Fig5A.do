...
log using "Fig5A.log", replace

* Y missing dependent on C and X, C missing dependent on X and Y, Y complete
...
/* Scenario RY dep on C and X, RC dep on Y and X*/
...
gen pselc=0.5
replace pselc=0.9 if x<=try2&y<=try3
replace pselc=0.1 if x>try2&y>try3
